...
tagar_periode %>%
  acast(tagar ~ periode, value.var = "n", fill = 0) %>%
  comparison.cloud(colors = c("darkturquoise", "coral1", "brown3", "lightseagreen"), max.words = 1329)
...
tm_twit <- bigram_tm(tm_tochange$clean_text, number_of_topics = 4)
tm_twit
```
