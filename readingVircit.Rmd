...
## sumber data
rangkuman <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/rangkuman.rds")
## data eksplorasi
data_eksplorasi <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/data_eksplorasi.rds")
## time series
ts_change <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/ts_change.rds")
ts_gojek <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/ts_gojek.rds")
## table output
data_vircit <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/data_vircit.rds")
## semantic network
data_net <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/semantic_network.rds")
## social network
net_user <- readRDS("/Volumes/mydata/rSkilss/vircit-readings/net_user.rds")
...
downloadHandler(filename = function() {
     paste('result', as.character(input$sdata2), '.csv', sep='')
   },
...
# help text -----------------------------------------------------------------------------
helpText("KETERANGAN: Untuk membaca network arahkan kursor pada salah satu node dan melihat arah dan keterhubungannya dengan node lain. Gunakan scroll untuk memperbesar tampilan network.")
...
Help {data-orientation="rows" data-icon="glyphicon-question-sign"}
=========================================================================================

How to1? {vertical_layout: scroll}
-----------------------------------------------------------------------------------------