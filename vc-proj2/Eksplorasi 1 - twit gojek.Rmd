...
# Eksplorasi 2 - Username
Gambar di bawah ini digunakan untuk melihat username yang paling sering muncul dalam data. 
...
Hasil di atas menunjukkan bahwa sebuah kata, cenderung berdampingan dengan kata lain. Misalnya, di sini dapat dilihat bahwa kata online berdekatan atau cenderung berasosiasi dengan kata taksi, angkutan, dan transportasi. Sementara kata karya, berdampingan dengan kata anak dan bangsa. 
...
Topik pertama cenderung membahas tentang apa gojek dalam persepsi username. Dalam hal ini gojek sebagai karya anak bangsa. Selain itu, dalam topik 1 gojek juga didefinisikan sebagai transportasi onlin. Namun, di sini juga ada topik tentang demo yang dilakukan oleh driver. Hal ini berkaitan dengan tagar savedriver gojek yang untuk mendiskusikan kebijakan tarif yang diterapkan oleh PT GI.

# Eksplorasi 9 - Username' Network
...
feat <- names(topfeatures(gojek_fcm, 75))
...
Gambar di atas menunjukkan username Twitter yang sering berada bersamaan. Dalam konteks ini, hal tersebut dapat diasumsikan sebagai username paling sering disebut (dimention) oleh pengguna twitter dalam twit yang didapat dengan parameter yang digunakan di sini.