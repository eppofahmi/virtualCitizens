...
ps_gojek %>%
  ...
  geom_col() + facet_wrap(~aplikasi) + coord_flip() + 
...
tm_ps_gojek <- bigram_tm(tm_ps$clean_text, number_of_topics = 2)
tm_ps_gojek
```

Secara umum, topik yang dibahas dalam komentar adalah tentang aplikasi dan permohonan untuk memperbaikinya. Permohonan tersebut disampaikan baik oleh kustomer maupun driver sebagai mitranya. 

Hal tersebut menunjukkan adanya interaksi dalam hubungan antara produsen (penyedia jasa) dalam hal ini PT GI, dengan kustomer dan mitra kerjanya. Di mana mereka bisa mendapatkan tilikan tentang apa yang diinginkan atau dibutuhkan oleh mitra dan kustomernya melalui komentar terhadap aplikasi di playstore. 